      ...
      <div className="home-about__container container">
        <div className="home-about__content">
          ...
          <p className="home-about__content-text">
            Fix&Frame is an industry leader providing our clients a comprehensive
            range of solutions to help manage and maintain their properties
            effectively yielding the highest return.
          </p>
